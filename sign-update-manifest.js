...
const privateKey = String(process.env.SWIRL_UPDATE_PRIVATE_KEY || '')
  .replace(/\\n/g, '\n')
  .trim();
...
if (!privateKey.includes('BEGIN PRIVATE KEY'))
  throw new Error('SWIRL_UPDATE_PRIVATE_KEY must contain an Ed25519 private key in PEM format.');
